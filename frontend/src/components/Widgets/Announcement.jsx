...
const Announcement = () => {
  ...
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      ...
      >
        <div
          className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-[#7dd3fc] to-[#3b82f6] opacity-30"
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm leading-6 text-gray-900">
          <strong className="font-semibold">Momentous supplements</strong>
          <svg viewBox="0 0 2 2" className="mx-2 inline h-0.5 w-0.5 fill-current" aria-hidden="true">
            <circle cx="1" cy="1" r="1" />
          </svg>
          14% off your order · 35% off new subscriptions · discount auto-applied at checkout (or use code <strong>ORACLE</strong>)
        </p>
        <a
          href="https://crrnt.app/MOME/pmnbzWOY"
          target="_blank"
          rel="noopener noreferrer"
          data-umami-event="momentous-banner"
